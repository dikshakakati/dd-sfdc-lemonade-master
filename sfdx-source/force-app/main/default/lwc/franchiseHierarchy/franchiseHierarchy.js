...
import franchiseHierarchy from "@salesforce/label/c.Display_Franchise_Hierarchy_View_Title";
import toggleStores from "@salesforce/label/c.Toggle_Stores_To_View_Business_Store_Accounts_In_Hierarchy";

export default class FranchiseHierarchy extends NavigationMixin(
  LightningElement
) {
  @api recordId;
  objectName = "Account";
  fieldSetName = "Account_Hierarchy_Default_Fields";
  maxColumns = "10";
  gridColumns;
  gridFields;
  requiredOptions = ["Name", "Total_Number_Of_Stores__c"];
  reportName = "Franchise_Hierarchy_Report_Id";
