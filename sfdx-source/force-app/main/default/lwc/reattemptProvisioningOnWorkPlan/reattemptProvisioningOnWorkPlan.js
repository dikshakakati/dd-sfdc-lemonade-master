 ...
 * @author atg
 * @date 08/08/2022
 * @description JavaScript controller for reattempProvisioningOnWorkPlan lightning web component.
 */
...
import reattemptProvisioning from '@salesforce/apex/ReattemptProvisioningOnWorkPlanCtrl.reattemptProvisioning';
...
const LWC_NAME = 'ReattemptProvisioningOnWorkPlan';

export default class ReattemptProvisioningOnWorkPlan extends LightningElement {
  @api recordId;
  ...
  */
  triggerReattmeptProvisioning() {
    reattemptProvisioning({
      parentWorkPlanId: this.recordId
    })
      .then(result => {
